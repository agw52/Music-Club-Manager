...
int pageFlipSound;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        next = getView().findViewById(R.id.page5nextbutton);
        previous = getView().findViewById(R.id.page5previousbutton);
    ...
    public interface page5Reporter{
        void passPage5();
    }
    ...
    public void onAttach(@NonNull Context context) {
        ...
        pageReporter = (page5Reporter) context;
    }
}