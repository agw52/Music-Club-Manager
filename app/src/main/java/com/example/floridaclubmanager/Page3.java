...
int pageFlipSound;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        next = getView().findViewById(R.id.page3nextbutton);
        previous = getView().findViewById(R.id.page3previousbutton);
    ...
    public interface page3Reporter{
        void passPage3();
    }
    ...
    public void onAttach(@NonNull Context context) {
        ...
        pageReporter = (page3Reporter) context;
    }
}